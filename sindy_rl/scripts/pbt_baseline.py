...
if __name__ == "__main__":
    ...
    drl_config["environment"]["env"] = getattr(
        registry, drl_config["environment"]["env"]
    )

    drl_default_config = (
        drl_default_config.rl_module(_enable_rl_module_api=False)
        .environment(**drl_config["environment"])
        .training(**drl_config["training"], _enable_learner_api=False)
